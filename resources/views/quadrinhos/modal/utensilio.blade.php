    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="btn btn-success ml-3" data-dismiss="modal" onclick="confirmarUtensilio('{{$caminho_imagem}}'); reconheceObjetos();">Confirmar</button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="buttonCloseModal" data-dismiss="modal" onclick="confirmarUtensilio('{{$caminho_imagem}}'); reconheceObjetos();">Confirmar</button>
